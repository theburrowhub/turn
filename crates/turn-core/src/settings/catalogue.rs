    ...
    pub fn built_in() -> Self {
        Self {
            definitions: vec![
                ...
                Definition {
                    key: "records.event_retention_days",
                    area: Area::Records,
                    title: "Event retention",
                    description: "Discard old lifecycle and attention events after this many \
                                  days, while preserving the per-Session floor below.",
                    kind: ValueKind::Integer { min: 1, max: 3650 },
                    default: json!(30),
                    sensitivity: Sensitivity::Plain,
                    scopes: GLOBAL_ONLY,
                },
                Definition {
                    key: "records.event_limit",
                    area: Area::Records,
                    title: "Event record limit",
                    description: "Maximum event rows across this Turn installation. Newest \
                                  rows win, subject to the per-Session floor.",
                    kind: ValueKind::Integer {
                        min: 100,
                        max: 1_000_000,
                    },
                ...
                Definition {
                    key: "records.event_session_floor",
                    area: Area::Records,
                    title: "Events kept per Session",
                    description: "Minimum recent events retained for each Session even after \
                                  the age or installation-wide limit is reached.",
                    kind: ValueKind::Integer { min: 0, max: 1000 },
                    default: json!(50),
                    sensitivity: Sensitivity::Plain,
                    scopes: GLOBAL_ONLY,
                },
                Definition {
                    key: "records.preview_retention_days",
                    area: Area::Records,
                    title: "Preview retention",
                    description: "Discard old, already-redacted activity preview history after \
                                  this many days.",
                    kind: ValueKind::Integer { min: 1, max: 3650 },
                    default: json!(30),
                    sensitivity: Sensitivity::Plain,
                ...
                Definition {
                    key: "records.previews_per_agent",
                    area: Area::Records,
                    title: "Previews kept per Agent",
                    description: "Maximum recent activity preview rows retained for one Agent.",
                    kind: ValueKind::Integer { min: 1, max: 1000 },
                    default: json!(20),
                    sensitivity: Sensitivity::Plain,
                    scopes: GLOBAL_ONLY,
                },
                Definition {
                    key: "records.preview_limit",
                    area: Area::Records,
                    title: "Preview record limit",
                    description: "Maximum activity preview rows across this Turn installation.",
                    kind: ValueKind::Integer {
                        min: 100,
                        max: 100_000,
                    },
                ...
                Definition {
                    key: "records.terminal_history",
                    area: Area::Records,
                    title: "Durable terminal history",
                    description: "Keep private terminal checkpoints and journals for restart \
                                  display recovery. Turning it off removes this Session's \
                                  existing terminal history without stopping its processes.",
                    kind: ValueKind::Bool,
                    default: json!(true),
                    sensitivity: Sensitivity::Plain,
                    scopes: PERSISTED,
                ...
                Definition {
                    key: "records.terminal_journal_mib",
                    area: Area::Records,
                    title: "Terminal journal size",
                    description: "Maximum append-only terminal history per Pane before Turn \
                                  checkpoints and rotates it, in MiB.",
                    kind: ValueKind::Integer { min: 1, max: 64 },
                    default: json!(8),
                    sensitivity: Sensitivity::Plain,
                    scopes: GLOBAL_ONLY,
                },
                Definition {
                    key: "records.terminal_checkpoint_mib",
                    area: Area::Records,
                    title: "Terminal checkpoint size",
                    description: "Maximum compact terminal checkpoint per Pane, in MiB.",
                    kind: ValueKind::Integer { min: 1, max: 32 },
                    default: json!(4),
                    sensitivity: Sensitivity::Plain,
                    scopes: GLOBAL_ONLY,
                },
                Definition {
                    key: "records.daemon_log_mib",
                    area: Area::Records,
                    title: "Daemon diagnostic log size",
                    description: "Maximum owner-only companion log size, in MiB. Turn scrubs \
                                  known credential shapes whenever it enforces this limit.",
                    kind: ValueKind::Integer { min: 1, max: 64 },
                    default: json!(4),
                    sensitivity: Sensitivity::Plain,
                    scopes: GLOBAL_ONLY,
